                    ...
                    <div className="bg-white rounded-lg shadow-md p-8 mb-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <span className="font-semibold">Follow on X/Twitter</span>
                            </a>

                            {/* LinkedIn */}
                            <a 
                                href="https://www.linkedin.com/in/shubhadeep-bhowmik-74b5a214b/" 
                                target="_blank" 
                                rel="noopener noreferrer"
                            ...
                            {/* GitHub Main Account */}
                            <a 
                                href="https://github.com/SHUBHADEEPXT" 
                                target="_blank" 
                                rel="noopener noreferrer"
                                className="flex items-center p-4 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors"
                            >
                                <svg className="w-6 h-6 mr-3" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <span className="font-semibold">GitHub - Main Account</span>
                            </a>

                            {/* GitHub Second Account */}
                            <a 
                                href="https://github.com/DIFINDOXT" 
                                target="_blank" 
                                rel="noopener noreferrer"
                            ...
                            >
                                ...
                                <span className="font-semibold">GitHub - Dev Account</span>
                            </a>
                        </div>
                    </div>
                </div>
